...
if __name__ == '__main__':
    ...
    args.train_raw_path = r'?????/test_AMP_Escherichia_coli.csv'
    ...
    GPTmodel = GPT2LMHeadModel.from_pretrained('../model_ckpt')
    ...
    model.load_state_dict(torch.load('../model_ckpt/Ecoli_regress.pth', map_location={'cuda:0': 'cuda:0'}),strict=False)
    model.to(device)
    ...
    predict_score.to_csv('result_test/e_coli.csv', index=False, header=[''],  mode='a')