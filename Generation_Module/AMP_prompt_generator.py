...
if __name__ == '__main__':
    args = setup_args()
    args.model_path, args.vocab_path = 'Your Checkpoint', 'voc/vocab.txt'

    tokenizer = BertTokenizer(vocab_file=args.vocab_path)
    eos_id = tokenizer.sep_token_id
    pad_id = tokenizer.pad_token_id
    prompt_model_load = torch.load(f"{args.model_path}/pytorch_model.bin")
    ...
    output.to_csv('generated_amp_sequences.csv', index=False, header=False, sep=' ')
